...
//	private List<ItemListDTO> allItemDTOList =new ArrayList<ItemListDTO>();
	private List<String> allItemDTOList = new ArrayList<String>();
...
//		List<ItemListDTO> allItemDTOList =itemSelectDAO.getAllItemNameList();
		allItemDTOList =itemSelectDAO.getAllItemNameList();
...
//		}
	...
	public List<String> getAllItemDTOList() {
		return allItemDTOList;
	}

	public void setAllItemDTOList(List<String> allItemDTOList) {
